// Pure builders for nova-x-panel's subscription server: the subscription URLs plus
...
export function buildJsonSubscription(clients: SubClient[]): string {
  ...
  // nova-x-panel returns a single object for one client, an array for several.
