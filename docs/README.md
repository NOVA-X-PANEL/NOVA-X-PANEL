<p align="center">
  <a href="https://docs.sanaei.dev">
    <picture>
      ...
      <img src="public/logo-light.png" alt="nova-x-panel" width="180" />
    </picture>
  </a>
</p>

<h1 align="center">nova-x-panel Documentation</h1>

<p align="center">
  The official documentation and product site for
  <a href="https://github.com/NOVA-X-PANEL/nova-x-panel"><b>nova-x-panel</b></a> —
...
<p align="center">
  ...
  <a href="https://github.com/NOVA-X-PANEL/nova-x-panel/actions/workflows/docs-ci.yml"><img src="https://github.com/NOVA-X-PANEL/nova-x-panel/actions/workflows/docs-ci.yml/badge.svg" alt="CI" /></a>
...
This directory (`docs/` in the [nova-x-panel](https://github.com/NOVA-X-PANEL/nova-x-panel) monorepo) contains
...
The documentation walks you through nova-x-panel from first install to day-to-day operation:
