export const appName = 'nova-x-panel';
...
// The nova-x-panel product repository — used for the navbar GitHub link,
...
// Where these docs live in the nova-x-panel monorepo — used for "Edit on GitHub" links.
...
// AI-generated interactive wiki of the nova-x-panel codebase.
export const deepWikiUrl = `https://deepwiki.com/${productRepo.user}/${productRepo.repo}`;

// Official nova-x-panel community channel on Telegram (announcements & support).
