# nova-x-panel Custom Subscription Templates

nova-x-panel can render your users' subscription pages from your own custom HTML templates.

## How to use a Custom Template

1. Go to the nova-x-panel panel settings.
2. Under **Settings → Subscription → Information**, locate the **Sub Theme Directory** field.
3. Provide the absolute path to the folder containing your template (e.g. `/etc/nova-x-panel/sub_templates/my-theme/`).
4. Save the settings.

> **Note:** nova-x-panel does not ship any templates by default. Create your own template folder anywhere
