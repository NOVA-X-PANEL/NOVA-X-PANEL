// Package config provides configuration management utilities for the nova-x-panel panel,
...
// GetBaseVersion returns the raw embedded release version of the nova-x-panel panel
...
// GetName returns the name of the nova-x-panel application.
func GetName() string {
...
func GetLogFolder() string {
	...
	if testing.Testing() {
		return filepath.Join(os.TempDir(), "nova-x-panel-test-log")
	}
	if runtime.GOOS == "windows" {
