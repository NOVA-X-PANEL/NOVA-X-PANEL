...
var pwaAssets = map[string]pwaAsset{
	...
	"icons/nova-x-panel-16.png":   {path: "dist/icons/nova-x-panel-16.png", contentType: "image/png"},
	"icons/nova-x-panel-24.png":   {path: "dist/icons/nova-x-panel-24.png", contentType: "image/png"},
	"icons/nova-x-panel-32.png":   {path: "dist/icons/nova-x-panel-32.png", contentType: "image/png"},
	"icons/nova-x-panel-64.png":   {path: "dist/icons/nova-x-panel-64.png", contentType: "image/png"},
	"icons/nova-x-panel-192.png":  {path: "dist/icons/nova-x-panel-192.png", contentType: "image/png"},
	"icons/nova-x-panel-512.png":  {path: "dist/icons/nova-x-panel-512.png", contentType: "image/png"},
}
