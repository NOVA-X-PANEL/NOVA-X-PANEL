...
nova-x-panel is an open-source web control panel for managing Xray-core servers.

- Backend: Go 1.27, module `github.com/nova-x-panel/nova-x-panel/v3`, Gin and GORM.
...
- **nova-x-panel/mtg-multi** — the MTProto sidecar whose TOML (`[secrets]`,
...
- Linux install: `bash <(curl -Ls https://raw.githubusercontent.com/nova-x-panel/nova-x-panel/master/install.sh)`
...
- Docker image `ghcr.io/nova-x-panel/nova-x-panel`; PostgreSQL profile
