...
const outboundSubscriptionBodyParams: EndpointParam[] = [
  ...
  },
  {
    ...
    in: 'body (form)',
    type: 'string',
    desc: 'Custom User-Agent sent when fetching this subscription. Defaults to "nova-x-panel-outbound-sub/1.0".',
    optional: true,
    defaultValue: 'nova-x-panel-outbound-sub/1.0',
  },
  {
    name: 'updateInterval',
    in: 'body (form)',
...
export const sections: readonly Section[] = [
...

  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        summary: 'Check whether a newer nova-x-panel release is available on GitHub.',
      },
      {
        method: 'GET',
...

  {
    ...
    title: 'Nodes',
    description:
      'Manage remote nova-x-panel panels acting as nodes for a central panel. All endpoints under /panel/api/nodes.',
    endpoints: [
      {
        method: 'GET',
...

  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        summary:
          'Restart the entire nova-x-panel process after a 3-second grace period. The connection drops immediately; the panel comes back online ~5-10 seconds later.',
      },
      {
        method: 'POST',
