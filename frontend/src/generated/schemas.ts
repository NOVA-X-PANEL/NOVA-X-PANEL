...
export const SCHEMAS: Record<string, unknown> = {
  ...
  "Node": {
    "description": "Node represents a remote nova-x-panel panel registered with the central panel.\nThe central panel polls each node's existing /panel/api/server/status\nendpoint over HTTP using the per-node ApiToken to populate the runtime\nstatus fields below.",
    "properties": {
      "activeCount": {
        "example": 23,
        "type": "integer"
  ...
  "Setting": {
    "description": "Setting stores key-value configuration settings for the nova-x-panel panel.",
    "properties": {
      "id": {
        "type": "integer"
      },
  ...
  "User": {
    "description": "User represents a user account in the nova-x-panel panel.",
    "properties": {
      "id": {
        "type": "integer"
      },
