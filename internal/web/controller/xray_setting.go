...
func (a *XraySettingController) initRouter(g *gin.RouterGroup) {
	...
	g.GET("/getOutboundsTraffic", requirePanelPermission("cores", "read"), a.getOutboundsTraffic)
	g.GET("/getXrayResult", requirePanelPermission("cores", "read"), a.getXrayResult)

	g.POST("/", requirePanelPermission("cores", "read"), a.getXraySetting)
	g.POST("/warp/:action", requirePanelPermission("cores", "update"), a.warp)
	g.POST("/nord/:action", requirePanelPermission("cores", "update"), a.nord)
	g.POST("/pia/:action", requirePanelPermission("cores", "update"), a.pia)
	g.POST("/update", requirePanelPermission("cores", "update"), a.updateSetting)
	g.POST("/resetOutboundsTraffic", requirePanelPermission("cores", "update"), a.resetOutboundsTraffic)
	g.POST("/testOutbound", a.testOutbound)
	g.POST("/testOutbounds", a.testOutbounds)
	g.POST("/balancerStatus", a.balancerStatus)
	g.POST("/balancerOverride", requirePanelPermission("cores", "update"), a.balancerOverride)
