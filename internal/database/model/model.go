// Package model defines the database models and data structures used by the nova-x-panel panel.
package model
...
// User represents a user account in the nova-x-panel panel.
type User struct {
...
// Setting stores key-value configuration settings for the nova-x-panel panel.
type Setting struct {
	Id    int    `json:"id" form:"id" gorm:"primaryKey;autoIncrement"`
...
// Node represents a remote nova-x-panel panel registered with the central panel.
