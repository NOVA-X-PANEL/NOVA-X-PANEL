...
export default function AdminsPage() {
  ...
  const handleEdit = (admin: AdminDetails) => {
    ...
    form.reset({
      ...
      discord_webhook: admin.discord_webhook || '',
      sub_template: admin.sub_template || '',
      telegram_id: admin.telegram_id == null || admin.telegram_id === '' ? undefined : Number(admin.telegram_id),
      support_url: admin.support_url || '',
      profile_title: admin.profile_title || '',
      sub_domain: admin.sub_domain || '',
      note: admin.note || '',
      ...
      permission_overrides: {
        ...
        ...(admin.permission_overrides
          ? (() => {
              ...
              return {
                ...rest,
                expire_days_min: expire_min == null ? null : Math.round(Number(expire_min) / 86_400),
                expire_days_max: expire_max == null ? null : Math.round(Number(expire_max) / 86_400),
                on_hold_timeout_days_min: on_hold_timeout_min == null ? null : Math.round(Number(on_hold_timeout_min) / 86_400),
                on_hold_timeout_days_max: on_hold_timeout_max == null ? null : Math.round(Number(on_hold_timeout_max) / 86_400),
              }
            })()
          : {}),
      },
