...
MTG_MULTI_VER=$(curl -sfL "https://api.github.com/repos/nova-x-panel/mtg-multi/releases/latest" | sed -n 's/.*"tag_name": *"\([^"]*\)".*/\1/p' | head -n 1)
...
curl -sfLRO "https://github.com/nova-x-panel/mtg-multi/releases/download/${MTG_MULTI_VER}/${MTG_PKG}.tar.gz"
