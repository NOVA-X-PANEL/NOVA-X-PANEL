// Package web provides the main web server implementation for the nova-x-panel panel,
...
import (
	...
	"github.com/nova-x-panel/nova-x-panel/v3/internal/eventbus"
	...
	"github.com/nova-x-panel/nova-x-panel/v3/internal/util/common"
	"github.com/nova-x-panel/nova-x-panel/v3/internal/util/sys"
	"github.com/nova-x-panel/nova-x-panel/v3/internal/web/controller"
	"github.com/nova-x-panel/nova-x-panel/v3/internal/web/job"
	...
	"github.com/nova-x-panel/nova-x-panel/v3/internal/web/network"
	"github.com/nova-x-panel/nova-x-panel/v3/internal/web/runtime"
	"github.com/nova-x-panel/nova-x-panel/v3/internal/web/service"
	"github.com/nova-x-panel/nova-x-panel/v3/internal/web/service/discord"
	"github.com/nova-x-panel/nova-x-panel/v3/internal/web/service/email"
...
// Server represents the main web server for the nova-x-panel panel with controllers, services, and scheduled jobs.
type Server struct {
...
func (s *Server) initRouter() (*gin.Engine, error) {
	...
	engine.Use(sessions.Sessions("nova-x-panel", store))
...
func (s *Server) start(restartXray bool, startTgBot bool) (err error) {
	...
	controller.SetTestTgFunc(func() error {
		...
		s.tgbotService.SendMsgToTgbotAdmins("✅ Test message from nova-x-panel")
		return nil
	})
